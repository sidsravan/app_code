...
import { View, Image, TouchableOpacity, Platform, Pressable, Dimensions } from 'react-native'
        ...
        return (
            <View
                style={{
                    ...
                    borderTopWidth: 0.8, borderBottomWidth: 5, borderColor: '#ddd', borderTopColor:'#808080'
                }}
            >
                ...
                <TouchableOpacity
                    ...
                    <Image
                        source={
                            post.user_id === user.data.session_id && post.comment_count > 0
                                ? CommentColor
                                : Comment
                        }
                        resizeMode="stretch"
                    ...
                    />
                    <View>
                        <Text style={styles.text_color}>{post.comment_count !== null || post.comment_count !== undefined ? post.comment_count : null}</Text>
                    </View>
                </TouchableOpacity>
                
                 <View style={{flexDirection: 'row', alignItems: 'center'}}>
					<PostShare post={post} user={user} shared={shared} setShared={setShared} />
					<Text style={styles.text_color}>  Share</Text>
				</View>
            </View>
        )
    }
